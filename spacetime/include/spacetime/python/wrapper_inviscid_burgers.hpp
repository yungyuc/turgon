  ...
  : public WrapSolutionBase< WrapInviscidBurgersSolution, InviscidBurgersSolution >
{
      ...
      : base_type(mod, pyname, clsdoc)
    {
        ...
        (*this)
            ...
            .def(
                "felm",
                static_cast<InviscidBurgersFelm (wrapped_type::*)(size_t, bool)>(&wrapped_type::felm_at),
...
class
SPACETIME_PYTHON_WRAPPER_VISIBILITY
WrapInviscidBurgersFelm
  : public WrapElementBase< WrapInviscidBurgersFelm, InviscidBurgersFelm >
{

    using base_type = WrapElementBase< WrapInviscidBurgersFelm, InviscidBurgersFelm >;
    using wrapper_type = typename base_type::wrapper_type;
    using wrapped_type = typename base_type::wrapped_type;
    ...
    WrapInviscidBurgersFelm(pybind11::module & mod, const char * pyname, const char * clsdoc)
      : base_type(mod, pyname, clsdoc)
    {
        (*this)
            .def(
...
}; /* end class WrapInviscidBurgersFelm */
