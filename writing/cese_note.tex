...
point $(j,n)$, as shown in \figurename~\ref{f:cese_marching}.  Let
$\mathrm{SE}(j,n)$ denote the SE locating at the mesh point.  The value of
variable $u$ within the SE, written as $u(x,t;j,n)$, is approximated as
\begin{align*}
...
through the CE boundary depends only on the approximation of variables within
SEs.
...
By using the definition of $u^*$, the approximation for $u$ is written as
\begin{align*}
