...
dependent variable, and $(x, t)$ the space-time coordinate.  Let $\mathbf{h}
\defeq (f(u),u)^t$ (the superscript ${}^t$ here denotes transpose) in the
two-dimensional space-time Euclidean space, in which $x_1=x, x_2=t$.  The
